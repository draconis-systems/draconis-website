...
export default function Home() {
  return (
    ...
    <button className="neon-border-cyan text-lg glitch-button" style={{display: 'block'}}>
    TextBridge
    </button>
    <button className="neon-border-magenta text-lg glitch-button" style={{display: 'block'}}>
    Between the Lines
    </button>
    </div>
    </div>
